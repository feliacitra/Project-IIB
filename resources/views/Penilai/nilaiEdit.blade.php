...
@section('content')
    ...
    <div class="pb-2">
        <p style="display: flex; align-items: flex-end;">
            ...
            <!-- Home button -->
            <a href="{{ route('lihatjadwalpresentasi') }}">Lihat Jadwal Presentasi</a>&nbsp;> Nilai
        </p>
    </div>
    {{-- Data Pendaftar --}}
...
{{-- @dd($component->masterMember) --}}
            ...
            <div class="tab-pane fade" id="nav-selfAssessment" role="tabpanel" aria-lab elledby="nav-assessment-tab">
                ...
                {{-- Desk Evaluation --}}
                <div class="tab-pane fade" id="nav-deskEvaluation" role="tabpanel" aria-labelledby="nav-assessment-tab">
                    <div class="container-fluid py-4 px-4" style="height: 100%">
                        <div class="row">
                            <div class="col">
                                <div class="info-pair">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            @if(isset($mqDesk[1]))
                                            {{-- @dd($mqDesk) --}}
                                            <textarea disabled class="form-control col" name="catatan" id="catatanTambahan" cols="10" rows="4">{{ $mqDesk[1]->scs_notes }}</textarea>
                                            @else
                                        ...
                                        <div class="radio mt-4">
                                            ...
                                            <input type="radio" disabled id="lulus-desk" name="kelulusan-desk" value="Lulus" checked>
                                            <label for="lulus">Lulus</label>
                                            <input type="radio" disabled id="tidakLulus-desk" name="kelulusan-desk" value="Tidak Lulus">
                                            <label for="tidakLulus">Tidak Lulus</label>
                                            @else
                                            <input type="radio" disabled id="lulus-desk" name="kelulusan-desk" value="Lulus">
                                            <label for="lulus">Lulus</label>
                                            <input type="radio" disabled id="tidakLulus-desk" name="kelulusan-desk" value="Tidak Lulus" checked>
                                            <label for="tidakLulus">Tidak Lulus</label>
                                            @endif
                                        </div>
                                    </div>
