                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="radio mt-2">
                                        ...
                                        <input type="radio" disabled id="{{ $qr->mqr_id }}" name="answer[{{ $loop->parent->index }}]" value="{{ $qr->mqr_id }}" {{ ($qr->mqr_id == $component->startupComponentStatus[0]->registationAnswer[$questIdx]->mqr_id) ? "checked" : "" }} disabled>
